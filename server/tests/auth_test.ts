...
Deno.test("hashPassword: returns a string containing salt and hash", async () => {
  ...
  assertEquals(
    parts.length,
    3,
    "hash should have format: iterations.salt.hash",
  );
});
...
Deno.test("signCookie: returns a string with value and signature", async () => {
  ...
  assertEquals(
    result.includes("."),
    true,
    "signed cookie should contain a dot separator",
  );
});
...
Deno.test("verifyCookie: returns value for valid signature", async () => {
  ...
  assertEquals(
    result,
    "my-session-id",
    "verifyCookie should return the original value",
  );
});
...
Deno.test("verifyCookie: returns null for tampered cookie", async () => {
  ...
  assertEquals(
    result,
    null,
    "verifyCookie should return null for tampered cookie",
  );
});
...
Deno.test("verifyCookie: returns null for wrong secret", async () => {
  ...
  assertEquals(
    result,
    null,
    "verifyCookie should return null for wrong secret",
  );
});
...
Deno.test("verifyCookie: returns null for completely invalid string", async () => {
  ...
  assertEquals(
    result,
    null,
    "verifyCookie should return null for invalid format",
  );
});
...
Deno.test("signCookie + verifyCookie: roundtrip with special characters", async () => {
  ...
  assertEquals(
    result,
    value,
    "roundtrip should preserve value with special characters",
  );
});
